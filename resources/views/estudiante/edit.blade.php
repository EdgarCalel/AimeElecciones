        ...
        <div class="card-body">
            ...
            <form class="row g-3" action="/estudiante/{{ $user->id }}" method="POST">
                ...
                <div class="col-md-6">
                    ...
                    <input id="escolaridad" name="escolaridad" type="text" class="form-control"
                        value="{{ $user->escolaridad }}">
                </div>
                <div class="col-md-6">
                    <label for="inputEmail4" class="form-label">Directiva</label>
                    <select name="DirectivaSelect" class=" form-control form-select form-select-sm col-md-12">
                ...
                <div class="justify-content-center align-item-center col-md-12">
                    ...
                    <div class="registerDirectiva2 col-md-12 mt-3 justify-content-center align-item-center ">
                        <div class="justify-content-center align-center">
                            <img src="/imagen/estudiante/{{ $user->foto_perfil }}" class="img-responsive" id="imagenSeleccionada"
