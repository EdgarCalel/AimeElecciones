                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-lg" placeholder="Nombres"
                                                id="nombres" name="nombres" tabindex="1" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-lg" placeholder="Nombres"
                                                id="apellidos" name="apellidos" tabindex="1" required>
                                        </div>
                                    </div>

                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-lg" placeholder="puesto"
                                                id="puesto" name="puesto" tabindex="1">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
      ...
      <option value="3">Tercero</option>
                                            ...
                                            <select name="Grado" class="form-control form-select-md col-md-12" required>
                                                ...
                                                @foreach ($gradoSel as $item)
                                                    <option value="{{ $item->id }}">{{ $item->nombre_grado }}
                                                        {{ $item->seccion }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-lg" placeholder="Seccion"
                                                id="seccion" name="seccion" tabindex="1" required>
                                        </div>
                                    </div>
                                    <div id="formColors">
                                        ...
                                        <label class="file">
                                            <input type="file" name="imagen" id="imagen"
                                                class="hidden mb-3 custom-file-inputs" aria-label="File browser example">
